...
The current production release for MC is `O2PDPSuite::MC-prod-2025-v5-1`.
...
| `O2PDPSuite::MC-prod-2025-v5-1` | **Current** | 18/07/2025 | Produced from master/dev - daily tag `O2DPGSuite::daily-20250718-0000-1`. Fixes for special runs / AOD production tags. |
