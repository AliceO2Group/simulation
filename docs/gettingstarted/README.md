...
| --skipModules arg | list of modules excluded in geometry (precendence over -m) See [transport section](../transport/) |
...
| --skipReadoutDetectors arg | list of detectors to skip hit creation (precendence over --readoutDetectors). See [transport section](../transport/) |
